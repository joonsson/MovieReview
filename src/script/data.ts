...
export const SWep5: Ireview = {
  ...
  text: "After the rebels are overpowered by the Empire on their newly established base" +
    ...
    " ally as Darth Vader hunts them in a plan to capture Luke. ",
  title: "Star Wars V: The Empire Strikes Back",
};

export const SWep6: Ireview = {
  actors: ["Mark Hamill", "Carrie Fisher", "Harrison Ford"],
  ...
  text: "After a daring mission to rescue Han Solo from Jabba the Hutt, " +
    ...
    "Luke struggles to help Vader back from the dark side without falling into the Emperor's trap. ",
